...
function CheckAns() {
    ...
    if (TotalStart == TotalEnd) {
        ...
        if (CLE == false && CLG == false && CLK == false && CLN == false && CRE == false && CRG == false && CRK == false && CRN == false) {
                ...
                if (((selectedOptionR1 == "POWave" && TotalTransferInR1 > 0 && (selectedOptionR2 == "" || selectedOptionR2 == "POWave" || selectedOptionR2 == "Heat")) || (selectedOptionR2 == "POWave" && TotalTransferInR2 > 0 && (selectedOptionR1 == "" || selectedOptionR1 == "POWave" || selectedOptionR1 == "Heat"))) || (((selectedOptionR1 == "POWave" && TotalTransferInR1 > 0) && (selectedOptionR2 == "Heat" && TotalTransferInR2 > 0)) || ((selectedOptionR2 == "POWave" && TotalTransferInR2 > 0) && (selectedOptionR1 == "Heat" && TotalTransferInR1 > 0) ))) {
                    ...
                    if ((CLC >= 1 && CLI >= 1) || (CLC >= 1 && CLI == 0)) {
                        ...
                        if (CRC < CLC && CRI > CLI) {
                            ...
                            document.getElementById("reply").innerHTML = `<button type="button" onclick="location.href='index4.html'">Next Qns</button>`;

                        }
                        else {
                            console.log("There should be less energy in the chemical store and more energy in the internal store in the final state of the system.");
                            document.getElementById("check").innerHTML = "*Incorrect*";
                            document.getElementById("reply").innerHTML = "There should be less energy in the chemical store and more energy in the internal store in the final state of the system. ";

                        }

                    }
                    else {
                        console.log("There should be energy in the chemical and internal stores in the initial state of the system. ");
                        document.getElementById("check").innerHTML = "*Incorrect*";
                        document.getElementById("reply").innerHTML = "There should be energy in the chemical and internal stores in the initial state of the system OR only chemical store in the initial state.";

                    }

                }
                else {
                    console.log("There should be some energy transferred out of the system through the propagation of waves (light and infrared radiation) only. OR some energy transferred out of the system through the propagation of waves (light) and through heating (infrared radiation).");
                    document.getElementById("check").innerHTML = "*Incorrect*";
                    document.getElementById("reply").innerHTML = "There should be some energy transferred out of the system through the propagation of waves (light and infrared radiation). <br> OR <br> Some energy transferred out of the system through the propagation of waves (light) and through heating (infrared radiation).";
            ...
            console.log("The amount of energy in the elastic, gravitational, kinetic, and nuclear stores should be zero.");
            document.getElementById("check").innerHTML = "*Incorrect*";
            document.getElementById("reply").innerHTML = "The amount of energy in the elastic, gravitational, kinetic, and nuclear stores should be zero.";
