...
function CheckAns() {
    ...
    if (TotalStart == TotalEnd) {
        ...
        if (CLC == false && CLE == false && CLG == false && CLK == false && CLN == false && CRC == false && CRE == false && CRG == false && CRK == false && CRN == false) {
            ...
            if (TotalTransferInL1 == 0 && TotalTransferInL2 == 0) {
                ...
                if (((selectedOptionR1 == "Heat" && TotalTransferInR1 > 0 && (selectedOptionR2 == "" || selectedOptionR2 == "Heat" || selectedOptionR2 == "POWave")) || (selectedOptionR2 == "Heat" && TotalTransferInR2 > 0 && (selectedOptionR1 == "" || selectedOptionR1 == "Heat" || selectedOptionR1 == "POWave"))) || (((selectedOptionR1 == "Heat" && TotalTransferInR1 > 0) && (selectedOptionR2 == "POWave" && TotalTransferInR2 > 0)) || ((selectedOptionR1 == "POWave" && TotalTransferInR1 > 0) && (selectedOptionR2 == "Heat" && TotalTransferInR2 > 0)))) {
                    ...
                    if (CLI >= 1) {
                        ...
                        if (CRI < CLI) {
                            ...
                            if (CRI >= 1) {
                                ...
                                document.getElementById("reply").innerHTML = `<button type="button" onclick="location.href='index5.html'">Next Qns</button>`;
                            }
                            else {
                                console.log("There should be energy in the internal store in the final state of the system.");
                                document.getElementById("check").innerHTML = "*Incorrect*";
                                document.getElementById("reply").innerHTML = "There should be energy in the internal store in the final state of the system.";
                            }


                        }
                        else {
                            console.log("There should be less energy in the internal store in the final state of the system.");
                            document.getElementById("check").innerHTML = "*Incorrect*";
                            document.getElementById("reply").innerHTML = "There should be less energy in the internal store in the final state of the system.";

                        }

                    }
                    else {
                        console.log("There should be energy in the internal store in the initial state of the system.");
                        document.getElementById("check").innerHTML = "*Incorrect*";
                        document.getElementById("reply").innerHTML = "There should be energy in the internal store in the initial state of the system.";

                    }

                }
                else {
                    console.log("There should be some energy transferred out of the system through heating. OR some energy transferred out of the system through the propagation of waves and through heating.");
                    document.getElementById("check").innerHTML = "*Incorrect*";
                    document.getElementById("reply").innerHTML = "There should be some energy transferred out of the system through heating only. <br> OR <br> Some energy transferred out of the system through the propagation of waves and through heating.";
