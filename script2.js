    ...
    if (TotalStart == TotalEnd) {
        ...
        if (CLE == false && CLG == false && CLK == false && CLN == false && CRE == false && CRG == false && CRK == false && CRN == false) {
            ...
            if (TotalTransferInR1 == 0 && TotalTransferInR2 == 0) {
                ...
                if ((selectedOptionL == "Electric" && TotalTransferInL1 > 0 && (selectedOptionL2 == "" || selectedOptionL2 == "Electric")) || (selectedOptionL2 == "Electric" && TotalTransferInL2 > 0 && (selectedOptionL == "" || selectedOptionL == "Electric"))) {
                    ...
                    if ((CLC >= 1 && CLI >= 1) || (CLC >= 1 && CLI == 0)) {
                        ...
                        if (CRI > CLI) {
                            ...
                            if (CRC == (CLC * 2)) {
                                ...
                                document.getElementById("reply").innerHTML = `<button type="button" onclick="location.href='index3.html'">Next Qns</button>`;
                            }
                            else {
                                console.log("There should be two times more energy in the chemical store in the final state of the system.");
                                document.getElementById("check").innerHTML = "*Incorrect*";
                                document.getElementById("reply").innerHTML = "There should be two times more energy in the chemical store in the final state of the system.";
                            }
                        ...
                        document.getElementById("check").innerHTML = "*Incorrect*";
                        document.getElementById("reply").innerHTML = "There should be energy in the chemical and internal stores in the initial state of the system";

                    }

                }
                else {
                    console.log("There should be some energy transferred into the system electrically from the electrical mains. ");
                    document.getElementById("check").innerHTML = "*Incorrect*";
                    document.getElementById("reply").innerHTML = "There should be some energy transferred into the system electrically from the electrical mains only.";
