...
function CheckAns() {
    ...
    if (TotalStart == TotalEnd) {
        ...
        if (CLC == false && CLE == false && CLG == false && CLI== false && CLN == false && CRC == false && CRE == false && CRG == false && CRI == false && CRN == false) {
                ...
                if ((selectedOptionL == "Mechanic" && TotalTransferInL1 > 0 && (selectedOptionL2 == "" || selectedOptionL2 == "Mechanic")) || (selectedOptionL2 == "Mechanic" && TotalTransferInL2 > 0 && (selectedOptionL == "" || selectedOptionL == "Mechanic"))) {
                    ...
                    if (CLK >= 1) {
                        ...
                        if (CRK >= 1 && CRK > CLK) {
                            ...
                            document.getElementById("reply").innerHTML = `<button type="button" onclick="location.href='index2.html'">Next Qns</button>`;

                        }
                        else {
                            console.log("There should be more energy in the kinetic store in the final state of the system. ");
                            document.getElementById("check").innerHTML = "*Incorrect*";
                            document.getElementById("reply").innerHTML = "There should be more energy in the kinetic store in the final state of the system. ";

                        }

                    }
                    else {
                        console.log("There should only be energy in the kinetic store in the initial state of the system.");
                        document.getElementById("check").innerHTML = "*Incorrect*";
                        document.getElementById("reply").innerHTML = "There should only be energy in the kinetic store in the initial state of the system.";

                    }

                }
                else {
                    console.log("There should be some energy transferred into the system mechanically due to the work done by the child on the car. ");
                    document.getElementById("check").innerHTML = "*Incorrect*";
                    document.getElementById("reply").innerHTML = "There should be some energy transferred into the system mechanically due to the work done by the child on the car only. ";
            ...
            console.log("The amount of energy in the chemical, elastic, gravitational, internal and nuclear stores should be zero. ");
            document.getElementById("check").innerHTML = "*Incorrect*";
            document.getElementById("reply").innerHTML = "The amount of energy in the chemical, elastic, gravitational, internal and nuclear stores should be zero. ";
