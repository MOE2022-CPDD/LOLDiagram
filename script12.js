...
function CheckAns() {
    ...
    if (TotalStart == TotalEnd) {
        ...
        if (CLE == false && CLK == false && CLN == false && CRE == false && CRK == false && CRN == false) {
                    ...
                    if ((CLC >= 1 && CLI >= 1) || (CLC >= 1 && CLI == 0)) {
                        ...
                        if (CRC < CLC && CRG >= 1) {
                            ...
                            if (CRI > CLI) {
                                ...
                                document.getElementById("reply").innerHTML = `<button type="button" onclick="location.href='#'">Complete</button>`;
                            ...
                            console.log("There should be less energy in the chemical and gravitational store in the final state of the system.");
                            document.getElementById("check").innerHTML = "*Incorrect*";
                            document.getElementById("reply").innerHTML = "There should be less energy in the chemical store in the final state of the system. <br> There should be some energy in the gravitational store in the final state of the system.";

                        }

                    }
                    else {
                        console.log("There should be some energy in the chemical and internal store in the initial state of the system OR only some energy in the chemical store in the initial state of the system.");
                        document.getElementById("check").innerHTML = "*Incorrect*";
                        document.getElementById("reply").innerHTML = "There should be some energy in the chemical and internal store in the initial state of the system <br> OR <br> only some energy in the chemical store in the initial state of the system.";
            ...
            console.log("The amount of energy in the elastic, kinetic and nuclear stores should be zero.");
            document.getElementById("check").innerHTML = "*Incorrect*";
            document.getElementById("reply").innerHTML = "The amount of energy in the elastic, kinetic and nuclear stores should be zero.";
