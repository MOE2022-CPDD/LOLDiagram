...
function CheckAns() {
    ...
    if (TotalStart == TotalEnd) {
        ...
        if (CLC == false && CLE == false && CLG == false && CLK == false && CLI == false && CRC == false && CRE == false && CRG == false && CRI == false) {
                    ...
                    if (CLN >= 1) {
                        ...
                        if (CRN < CLN) {
                            ...
                            if (CRK >= 1) {
                                ...
                                document.getElementById("reply").innerHTML = `<button type="button" onclick="location.href='index9.html'">Next Qns</button>`;

                            }
                            else {
                                console.log("There should be some energy in the kinetic store in the final state of the system. ");
                                document.getElementById("check").innerHTML = "*Incorrect*";
                                document.getElementById("reply").innerHTML = "There should be some energy in the kinetic store in the final state of the system. ";

                            }
                        }
                        else {
                            console.log("There should be less energy in the nuclear store in the final state of the system. ");
                            document.getElementById("check").innerHTML = "*Incorrect*";
                            document.getElementById("reply").innerHTML = "There should be less energy in the nuclear store in the final state of the system.";
                        }

                    }
                    else {
                        console.log("There should be energy in the nuclear store in the initial state of the system.");
                        document.getElementById("check").innerHTML = "*Incorrect*";
                        document.getElementById("reply").innerHTML = "There should be energy in the nuclear store in the initial state of the system.";

                    }

                }
                else {
                    console.log("There should be some energy transferred out of the system through the propagation of waves (gamma radiation).");
                    document.getElementById("check").innerHTML = "*Incorrect*";
                    document.getElementById("reply").innerHTML = "There should be some energy transferred out of the system through the propagation of waves (gamma radiation) only.";
            ...
            console.log("The amount of energy in the chemical, elastic, gravitational, kinetic, and internal stores should be zero.");
            document.getElementById("check").innerHTML = "*Incorrect*";
            document.getElementById("reply").innerHTML = "The amount of energy in the chemical, elastic, gravitational, kinetic, and internal stores should be zero.";
