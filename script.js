...
function CheckAns() {
    ...
    if (TotalStart == TotalEnd) {
        ...
        if (CLC == false && CLE == false && CLG == false && CLN == false && CRC == false && CRE == false && CRG == false && CRN == false) {
            ...
            if (TotalTransferInL1 == 0 && TotalTransferInL2 == 0) {
                ...
                if ((selectedOptionR1 == "Mechanic" && TotalTransferInR1 > 0) || (selectedOptionR2 == "Mechanic" && TotalTransferInR2 > 0)) {
                    ...
                    if (CLI == false && CLK >= 1) {
                        ...
                        if (CRK == false && CRI >= 1) {
                            ...
                            document.getElementById("reply").innerHTML = `<button type="button" onclick="location.href='index1.html'">Next Qns</button>`;

                        }
                        else {
                            console.log("There should be no energy in the kinetic store and some energy in the internal store in the final state of the system.");
                            document.getElementById("check").innerHTML = "*Incorrect*";
                            document.getElementById("reply").innerHTML = "There should be no energy in the kinetic store and some energy in the internal store in the final state of the system.";
                    ...
                    console.log("There should be some energy transferred out of the system mechanically due to the work done against friction.");
                    document.getElementById("check").innerHTML = "*Incorrect*";
                    document.getElementById("reply").innerHTML = "There should be some energy transferred out of the system mechanically due to the work done against friction.";
            ...
            console.log("The amount of energy in the chemical, elastic, gravitational and nuclear stores should be zero.");
            document.getElementById("check").innerHTML = "*Incorrect*";
            document.getElementById("reply").innerHTML = "The amount of energy in the chemical, elastic, gravitational and nuclear stores should be zero.";
