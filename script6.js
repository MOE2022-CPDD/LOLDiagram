...
function CheckAns() {
    ...
    if (TotalStart == TotalEnd) {
        ...
        if (CLC == false && CLE == false && CRC == false && CRE == false && CLN == false && CRN == false) {
            ...
            if (TotalTransferInL1 == 0 && TotalTransferInL2 == 0) {
                ...
                if ((selectedOptionR1 == "Mechanic" && TotalTransferInR1 > 0 && (selectedOptionR2 == "" || selectedOptionR2 == "Mechanic")) || (selectedOptionR2 == "Mechanic" && TotalTransferInR2 > 0 && (selectedOptionR1 == "" || selectedOptionR1 == "Mechanic"))) {
                    ...
                    //5 Initial state only has g
                    if (CRK >= 1 && CRI > CLI) {



                        if ((CLG >= 1 && CLI == 0 && CLK == false) ||(CLG >= 1 && CLI >=1 && CLK == false)) {


                            //7 Final state no K but with some I
                            if (CLG == (CRG * 2)) {
                                console.log("CLG " + CLG);

                                console.log("CRG " + CRG);
                                document.getElementById("check").innerHTML = "*<b><u>*Correct*</u></b>*";
                                document.getElementById("reply").innerHTML = `<button type="button" onclick="location.href='index7.html'">Next Qns</button>`;

                            }
                            else {
                                console.log("The amount of energy in the gravitational store in the initial state of the system should be two times more than the amount of energy in the gravitational store in the final state of the system.");
                                document.getElementById("check").innerHTML = "*Incorrect*";
                                // document.getElementById("reply").innerHTML = "There should be some energy in the kinetic store and some energy in the internal store in the final state of the system.";
                                document.getElementById("reply").innerHTML = "The amount of energy in the gravitational store in the initial state of the system should be two times more than the amount of energy in the gravitational store in the final state of the system.";
                            ...
                            console.log("There should be some energy in the internal store in the initial state of the system. <br> OR <br> There is no energy in the internal store in the initial state of the system.");
                            document.getElementById("check").innerHTML = "*Incorrect*";
                            document.getElementById("reply").innerHTML = "There should be some energy in the internal store in the initial state of the system. <br> OR <br> There is no energy in the internal store in the initial state of the system.";

                        }

                    }
                    else {
                        console.log("There should be some energy in the kinetic store and more energy in the internal store in the final state of the system.");
                        document.getElementById("check").innerHTML = "*Incorrect*";
                        document.getElementById("reply").innerHTML = "There should be some energy in the kinetic store and more energy in the internal store in the final state of the system.";

                    }

                }
                else {
                    console.log("There should be some energy transferred out of the system mechanically due to the work done against air resistance.");
                    document.getElementById("check").innerHTML = "*Incorrect*";
                    document.getElementById("reply").innerHTML = "There should be some energy transferred out of the system mechanically due to the work done against air resistance only.";
            ...
            console.log("The amount of energy in the chemical, elastic and nuclear stores should be zero.");
            document.getElementById("check").innerHTML = "*Incorrect*";
            document.getElementById("reply").innerHTML = "The amount of energy in the chemical, elastic and nuclear stores should be zero.";

        }
    }
    else {
        console.log("The total energy in the initial state of the system plus the energy transferred into the system should be equal to the total energy in the final state of the system plus the energy transferred out of the system.Total initial + transferred in = total final + transferred out");
        document.getElementById("check").innerHTML = "*Incorrect*";
