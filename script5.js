...
function CheckAns() {
    ...
    if (TotalStart == TotalEnd) {
        ...
        if (CLC == false && CLE == false && CLK == false  && CLI == false && CLN == false && CRC == false && CRE == false && CRK == false && CRI == false && CRN == false) {



            //3 Zero transfer out
            if (TotalTransferInR1 == 0 && TotalTransferInR2 == 0) {

                //4 Some transfer out mechanically
                if ((selectedOptionL == "Mechanic" && TotalTransferInL1 > 0 && (selectedOptionL2 == "" || selectedOptionL2 == "Mechanic")) || (selectedOptionL2 == "Mechanic" && TotalTransferInL2 > 0 && (selectedOptionL == "" || selectedOptionL == "Mechanic"))) {
                    ...
                    if (CLG >= 0) {
                        ...
                        if (CRG > CLG) {
                            ...
                            document.getElementById("reply").innerHTML = `<button type="button" onclick="location.href='index6.html'">Next Qns</button>`;

                        }
                        else {
                            console.log("There should be energy in the gravitational store in the final state of the system.");
                            document.getElementById("check").innerHTML = "*Incorrect*";
                            document.getElementById("reply").innerHTML = "There should be more energy in the gravitational store in the final state of the system.";

                        }

                    }
                    else {
                        console.log("There should be no energy in any store in the initial state of the system.");
                        document.getElementById("check").innerHTML = "*Incorrect*";
                        document.getElementById("reply").innerHTML = "There should be no energy in any store in the initial state of the system. <br> OR <br> There should be some energy in the gravitational store in the initial state of the system.";

                    }

                }
                else {
                    console.log("There should be some energy transferred into the system mechanically due to the work done by the mother when she pushed the girl.");
                    document.getElementById("check").innerHTML = "*Incorrect*";
                    document.getElementById("reply").innerHTML = "There should be some energy transferred into the system mechanically due to the work done by the mother when she pushed the girl.";

                }
            }
            else {
                console.log("The energy transferred out of the system should be zero.");
                document.getElementById("check").innerHTML = "*Incorrect*";
                document.getElementById("reply").innerHTML = "The energy transferred out of the system should be zero.";

            }

        }
        else {
            console.log("The amount of energy in the chemical, elastic, kinetic, internal, and nuclear stores should be zero.");
            document.getElementById("check").innerHTML = "*Incorrect*";
            document.getElementById("reply").innerHTML = "The amount of energy in the chemical, elastic, kinetic, internal, and nuclear stores should be zero.";
