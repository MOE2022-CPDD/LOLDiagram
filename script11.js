...
function CheckAns() {
    ...
    if (TotalStart == TotalEnd) {
        ...
        if (CLC == false && CLE == false && CLK == false && CLN == false && CRC == false && CRE == false && CRK == false && CRN == false) {
            ...
            if (TotalTransferInL1 == 0 && TotalTransferInL2 == 0) {
                ...
                if ((selectedOptionR1 == "POWave" && TotalTransferInR1 > 0 && (selectedOptionR2 == "" || selectedOptionR2 == "POWave")) || (selectedOptionR2 == "POWave" && TotalTransferInR2 > 0 && (selectedOptionR1 == "" || selectedOptionR1 == "POWave"))) {


                    //5 Initial state only has K
                    if ((CLG >= 1 && CLI >= 1) || (CLG >= 1 && CLI == 0)) {



                        //6 Final state no K but with some I
                        if (CRG == false && CRI > CLI) {
                            document.getElementById("check").innerHTML = "<b><u>*Correct*</u></b>";
                            document.getElementById("reply").innerHTML = `<button type="button" onclick="location.href='index12.html'">Next Qns</button>`;

                        }
                        else {
                            console.log("There should be no energy in the gravitational store and some more energy in the internal store in the final state of the system.");
                            document.getElementById("check").innerHTML = "*Incorrect*";
                            document.getElementById("reply").innerHTML = "There should be no energy in the gravitational store and some more energy in the internal store in the final state of the system.";

                        }

                    }
                    else {
                        console.log("There should be some energy in the gravitational and internal store in the initial state of the system OR only energy in the gravitational store in the initial state of the system.");
                        document.getElementById("check").innerHTML = "*Incorrect*";
                        document.getElementById("reply").innerHTML = "There should be some energy in the gravitational and internal store in the initial state of the system <br> OR <br> only energy in the gravitational store in the initial state of the system.";

                    }

                }
                else {
                    console.log("There should be some energy transferred out of the system through propagation of waves due to the sound produced.");
                    document.getElementById("check").innerHTML = "*Incorrect*";
                    document.getElementById("reply").innerHTML = "There should be some energy transferred out of the system through propagation of waves due to the sound produced only.";
            ...
            console.log("The amount of energy in the chemical, elastic, kinetic and nuclear stores should be zero.");
            document.getElementById("check").innerHTML = "*Incorrect*";
            document.getElementById("reply").innerHTML = "The amount of energy in the chemical, elastic, kinetic and nuclear stores should be zero.";
