...
function CheckAns() {
    ...
    if (TotalStart == TotalEnd) {
        ...
        if (CLC == false && CLG == false && CLI == false && CLN == false && CRC == false && CRG == false && CRI == false && CRN == false) {
            ...
            if (TotalTransferInL1 == 0 && TotalTransferInL2 == 0) {
                ...
                if (((selectedOptionR1 == "Mechanic" && TotalTransferInR1 > 0) && (selectedOptionR2 == "POWave" && TotalTransferInR2 > 0)) || (selectedOptionR1 == "POWave" && TotalTransferInR1 > 0) && (selectedOptionR2 == "Mechanic" && TotalTransferInR2 > 0)) {
                    ...
                    if (CLE >= 1) {
                        ...
                        if (CRE == false && CRK >= 1) {
                            ...
                            document.getElementById("reply").innerHTML = `<button type="button" onclick="location.href='index11.html'">Next Qns</button>`;

                        }
                        else {
                            console.log("There should be no energy in the elastic store and some energy in the kinetic store in the final state of the system.");
                            document.getElementById("check").innerHTML = "*Incorrect*";
                            document.getElementById("reply").innerHTML = "There should be no energy in the elastic store and some energy in the kinetic store in the final state of the system.";

                        }

                    }
                    else {
                        console.log("There should be some energy in the elastic store in the initial state of the system.");
                        document.getElementById("check").innerHTML = "*Incorrect*";
                        document.getElementById("reply").innerHTML = "There should be some energy in the elastic store in the initial state of the system.";

                    }

                }
                else {
                    console.log("There should be some energy transferred out of the system mechanically due to the work done against friction and through propagation of waves due to the sound produced.");
                    document.getElementById("check").innerHTML = "*Incorrect*";
                    document.getElementById("reply").innerHTML = "There should be some energy transferred out of the system mechanically due to the work done against friction and through propagation of waves due to the sound produced.";
            ...
            console.log("The amount of energy in the chemical, gravitational, internal, and nuclear stores should be zero.");
            document.getElementById("check").innerHTML = "*Incorrect*";
            document.getElementById("reply").innerHTML = "The amount of energy in the chemical, gravitational, internal, and nuclear stores should be zero.";
